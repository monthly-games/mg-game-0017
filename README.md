...
이 프로젝트는 **던전 크래프트**의 Flutter 구현체입니다.
...
| 문서 | 설명 |
|------|------|
| [docs/design/gdd_game_0017.json](docs/design/gdd_game_0017.json) | 게임 디자인 문서 |
...
**HUD 파일**: [game/lib/ui/hud/mg_dungeon_craft_hud.dart](game/lib/ui/hud/mg_dungeon_craft_hud.dart)

### 주요 HUD 요소

| 요소 | 설명 | 컴포넌트 |
|------|------|----------|
| **골드** | 던전 건설 골드 표시 | MGResourceBar |
| **마나** | 함정 및 마법 마나 표시 | MGResourceBar |
| **침략 진행도** | 현재 침략 진행 상황 | MGLinearProgress |
| **일시정지** | 게임 일시정지 버튼 | MGIconButton |
| **메뉴** | 설정 메뉴 버튼 | MGIconButton |
