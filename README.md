...
Puzzle-based RPG adventure

<!-- MG-GAME-SHOWCASE:START -->
## Gameplay Showcase

![Dungeon Craft Tycoon gameplay screen](docs/images/gameplay-showcase.png)

**Dungeon Craft Tycoon** centers on the **Upgrade and Grow** loop. The player enters from the main menu, reads the active objective and pressure state, performs the core action, banks rewards, then returns through roadmap and retention goals.
...
git clone --recursive https://github.com/monthly-games/mg-game-0017.git
