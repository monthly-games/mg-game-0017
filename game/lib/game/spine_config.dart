...
const kCrafterMeta = SpineAssetMeta(
  ...
  skeletonPath: 'assets/spine/characters/crafter/crafter.skel',
...
const kMinerMeta = SpineAssetMeta(
  ...
  skeletonPath: 'assets/spine/characters/miner/miner.skel',
  animations: ['idle', 'walk', 'attack', 'hit'],
  defaultAnimation: 'idle',
  defaultMix: 0.2,
);
...
const kMerchantMeta = SpineAssetMeta(
  ...
  skeletonPath: 'assets/spine/characters/merchant/merchant.skel',
  animations: ['idle', 'walk', 'attack', 'hit'],
  defaultAnimation: 'idle',
  defaultMix: 0.2,
);
